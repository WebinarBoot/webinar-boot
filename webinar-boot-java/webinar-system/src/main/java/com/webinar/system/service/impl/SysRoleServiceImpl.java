...
import com.webinar.system.domain.SysRoleDept;
        ...
        implements ISysRoleService
{
    ...
    @Override
    public SysRole getRoloById(SysUser user) {
        return userRoleMapper.getRoloById(user);
    }

    @Override
    public SysRole selectRoleByName(String roleName) {
        return roleMapper.selectOne(new QueryWrapper<SysRole>().eq("role_name",roleName));
    }
}
