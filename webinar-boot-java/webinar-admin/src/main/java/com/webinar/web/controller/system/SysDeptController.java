...
import com.webinar.common.core.domain.R;
...
public class SysDeptController extends BaseController
{
    ...
    public AjaxResult getLevelMarkList() {
        List<DeptVO> deptVOList = deptService.getDeptAllList();
        return success(deptVOList);
    }
    ...
    public AjaxResult list()
    {
        ...
        //List<SysDept> depts = deptService.getDeptAll();
